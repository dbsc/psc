...
/- Trait implementation: [core::convert::num::{(core::convert::From<bool> for u8)#28}]
   Source: '/rustc/d59363ad0b6391b7fc5bbb02c9ccf9300eef3753/library/core/src/convert/num.rs', lines 47:8-55:9
   Name pattern: core::convert::num::{core::convert::From<u8, bool>} -/
def core.convert.FromU8Bool : core.convert.From U8 Bool := {
  from := core.convert.num.FromU8Bool.from
}
...
divergent def biginteger.BigInt.const_sub_with_borrow_loop
  ...
  else Result.ret (self, borrow != 0#i32)
...
divergent def biginteger.BigInt.const_add_with_carry_loop
  ...
  else Result.ret (self, carry != 0#u64)
...
divergent def biginteger.BigInt.const_mul2_with_carry_loop
  ...
  else Result.ret (self, last != 0#u64)
...
/- [test::biginteger::{(core::convert::From<u64> for test::biginteger::BigInt<N>)#8}::from]:
   Source: 'src/biginteger/mod.rs', lines 804:4-804:34 -/
...
/- Trait implementation: [test::biginteger::{(core::convert::From<u64> for test::biginteger::BigInt<N>)#8}]
   Source: 'src/biginteger/mod.rs', lines 802:0-802:44 -/
def core.convert.FromtestbigintegerBigIntU64 (N : Usize) : core.convert.From
  (biginteger.BigInt N) U64 := {
  from := biginteger.FromtestbigintegerBigIntU64.from N
}

/- Trait implementation: [core::convert::num::{(core::convert::From<u32> for u64)#48}]
   Source: '/rustc/d59363ad0b6391b7fc5bbb02c9ccf9300eef3753/library/core/src/convert/num.rs', lines 47:8-55:9
   Name pattern: core::convert::num::{core::convert::From<u64, u32>} -/
def core.convert.FromU64U32 : core.convert.From U64 U32 := {
  from := core.convert.num.FromU64U32.from
}

/- [test::biginteger::{(core::convert::From<u32> for test::biginteger::BigInt<N>)#9}::from]:
   Source: 'src/biginteger/mod.rs', lines 813:4-813:34 -/
...
/- Trait implementation: [test::biginteger::{(core::convert::From<u32> for test::biginteger::BigInt<N>)#9}]
   Source: 'src/biginteger/mod.rs', lines 811:0-811:44 -/
def core.convert.FromtestbigintegerBigIntU32 (N : Usize) : core.convert.From
  (biginteger.BigInt N) U32 := {
  from := biginteger.FromtestbigintegerBigIntU32.from N
}

/- Trait implementation: [core::convert::num::{(core::convert::From<u16> for u64)#46}]
   Source: '/rustc/d59363ad0b6391b7fc5bbb02c9ccf9300eef3753/library/core/src/convert/num.rs', lines 47:8-55:9
   Name pattern: core::convert::num::{core::convert::From<u64, u16>} -/
def core.convert.FromU64U16 : core.convert.From U64 U16 := {
  from := core.convert.num.FromU64U16.from
}

/- [test::biginteger::{(core::convert::From<u16> for test::biginteger::BigInt<N>)#10}::from]:
   Source: 'src/biginteger/mod.rs', lines 822:4-822:34 -/
...
/- Trait implementation: [test::biginteger::{(core::convert::From<u16> for test::biginteger::BigInt<N>)#10}]
   Source: 'src/biginteger/mod.rs', lines 820:0-820:44 -/
def core.convert.FromtestbigintegerBigIntU16 (N : Usize) : core.convert.From
  (biginteger.BigInt N) U16 := {
  from := biginteger.FromtestbigintegerBigIntU16.from N
}

/- Trait implementation: [core::convert::num::{(core::convert::From<u8> for u64)#42}]
   Source: '/rustc/d59363ad0b6391b7fc5bbb02c9ccf9300eef3753/library/core/src/convert/num.rs', lines 47:8-55:9
   Name pattern: core::convert::num::{core::convert::From<u64, u8>} -/
def core.convert.FromU64U8 : core.convert.From U64 U8 := {
  from := core.convert.num.FromU64U8.from
}

/- [test::biginteger::{(core::convert::From<u8> for test::biginteger::BigInt<N>)#11}::from]:
   Source: 'src/biginteger/mod.rs', lines 831:4-831:33 -/
...
/- Trait implementation: [test::biginteger::{(core::convert::From<u8> for test::biginteger::BigInt<N>)#11}]
   Source: 'src/biginteger/mod.rs', lines 829:0-829:43 -/
def core.convert.FromtestbigintegerBigIntU8 (N : Usize) : core.convert.From
  (biginteger.BigInt N) U8 := {
  from := biginteger.FromtestbigintegerBigIntU8.from N
}
...
divergent def biginteger.BigIntegertestbigintegerBigIntN.add_with_carry_loop
  ...
  then
    ...
    biginteger.BigIntegertestbigintegerBigIntN.add_with_carry_loop N a other
      carry1 i4
  else Result.ret (carry != 0#u8, self)
...
divergent def biginteger.BigIntegertestbigintegerBigIntN.sub_with_borrow_loop
  ...
  then
    ...
    biginteger.BigIntegertestbigintegerBigIntN.sub_with_borrow_loop N a other
      borrow1 i4
  else Result.ret (borrow != 0#u8, self)
...
divergent def biginteger.BigIntegertestbigintegerBigIntN.mul2_loop
  ...
  else Result.ret (last != 0#u64, self)
...
/- [test::biginteger::{(test::biginteger::BigInteger<N> for test::biginteger::BigInt<N>)#5}::mul_low]:
   Source: 'src/biginteger/mod.rs', lines 539:4-539:43 -/
...
/- [test::biginteger::{(test::biginteger::BigInteger<N> for test::biginteger::BigInt<N>)#5}::mul_high]:
   Source: 'src/biginteger/mod.rs', lines 564:4-564:44 -/
...
/- [test::biginteger::{(test::biginteger::BigInteger<N> for test::biginteger::BigInt<N>)#5}::div2]: loop 0:
   Source: 'src/biginteger/mod.rs', lines 570:4-585:5 -/
...
/- [test::biginteger::{(test::biginteger::BigInteger<N> for test::biginteger::BigInt<N>)#5}::div2]:
   Source: 'src/biginteger/mod.rs', lines 570:4-570:22 -/
...
/- [test::biginteger::{(test::biginteger::BigInteger<N> for test::biginteger::BigInt<N>)#5}::divn]:
   Source: 'src/biginteger/mod.rs', lines 588:4-588:34 -/
...
/- [test::biginteger::{(test::biginteger::BigInteger<N> for test::biginteger::BigInt<N>)#5}::is_zero]: loop 0:
   Source: 'src/biginteger/mod.rs', lines 629:4-638:5 -/
...
/- [test::biginteger::{(test::biginteger::BigInteger<N> for test::biginteger::BigInt<N>)#5}::is_zero]:
   Source: 'src/biginteger/mod.rs', lines 629:4-629:29 -/
...
/- [test::biginteger::{(test::biginteger::BigInteger<N> for test::biginteger::BigInt<N>)#5}::num_bits]: loop 0:
   Source: 'src/biginteger/mod.rs', lines 641:4-661:5 -/
...
/- [test::biginteger::{(test::biginteger::BigInteger<N> for test::biginteger::BigInt<N>)#5}::num_bits]:
   Source: 'src/biginteger/mod.rs', lines 641:4-641:29 -/
...
/- [test::biginteger::{(test::biginteger::BigInteger<N> for test::biginteger::BigInt<N>)#5}::get_bit]:
   Source: 'src/biginteger/mod.rs', lines 664:4-664:39 -/
def biginteger.BigIntegertestbigintegerBigIntN.get_bit
  ...
  then Result.ret false
    ...
    let i4 ← 1#u64 <<< bit
    Result.ret (i3 &&& i4 != 0#u64)

/- Trait implementation: [core::clone::impls::{(core::clone::Clone for bool)#19}]
   Source: '/rustc/d59363ad0b6391b7fc5bbb02c9ccf9300eef3753/library/core/src/clone.rs', lines 179:16-184:17
   Name pattern: core::clone::impls::{core::clone::Clone<bool>} -/
def core.clone.CloneBool : core.clone.Clone Bool := {
  clone := core.clone.impls.CloneBool.clone
}

/- Trait implementation: [alloc::vec::{(core::ops::deref::Deref for alloc::vec::Vec<T, A>)#9}]
   Source: '/rustc/d59363ad0b6391b7fc5bbb02c9ccf9300eef3753/library/alloc/src/vec/mod.rs', lines 2620:0-2620:46
   Name pattern: alloc::vec::{core::ops::deref::Deref<alloc::vec::Vec<@T, @A>>} -/
def core.ops.deref.DerefallocvecVec (T A : Type) : core.ops.deref.Deref
  (alloc.vec.Vec T) := {
  Target := Slice T
  deref := alloc.vec.DerefallocvecVec.deref T A
}
...
/- Trait implementation: [alloc::vec::{(core::ops::deref::DerefMut for alloc::vec::Vec<T, A>)#10}]
   ...
   Name pattern: alloc::vec::{core::ops::deref::DerefMut<alloc::vec::Vec<@T, @A>>} -/
def core.ops.deref.DerefMutallocvecVec (T A : Type) : core.ops.deref.DerefMut
  (alloc.vec.Vec T) := {
  derefInst := core.ops.deref.DerefallocvecVec T A
  deref_mut := alloc.vec.DerefMutallocvecVec.deref_mut T A
}

/- [test::biginteger::{(test::biginteger::BigInteger<N> for test::biginteger::BigInt<N>)#5}::from_bits_be]:
   Source: 'src/biginteger/mod.rs', lines 675:4-675:42 -/
def biginteger.BigIntegertestbigintegerBigIntN.from_bits_be
  ...
  let (s, deref_mut_back) ←
    alloc.vec.DerefMutallocvecVec.deref_mut Bool alloc.alloc.Global bits1
  let s1 ← core.slice.Slice.reverse Bool s
  let bits2 ← deref_mut_back s1
  let s2 ← alloc.vec.DerefallocvecVec.deref Bool alloc.alloc.Global bits2
...
/- [test::biginteger::{(test::biginteger::BigInteger<N> for test::biginteger::BigInt<N>)#5}::from_bits_le]:
   Source: 'src/biginteger/mod.rs', lines 681:4-681:42 -/
...
/- [test::biginteger::{(test::biginteger::BigInteger<N> for test::biginteger::BigInt<N>)#5}::to_bytes_be]:
   Source: 'src/biginteger/mod.rs', lines 703:4-703:36 -/
def biginteger.BigIntegertestbigintegerBigIntN.to_bytes_be
  ...
  let (s, deref_mut_back) ←
    alloc.vec.DerefMutallocvecVec.deref_mut U8 alloc.alloc.Global le_bytes
...
/- [test::biginteger::{(test::biginteger::BigInteger<N> for test::biginteger::BigInt<N>)#5}::to_bytes_le]:
   Source: 'src/biginteger/mod.rs', lines 710:4-710:36 -/
def biginteger.BigIntegertestbigintegerBigIntN.to_bytes_le
  (N : Usize) (self : biginteger.BigInt N) : Result (alloc.vec.Vec U8) :=
  do
  let i ← N * 8#usize
  let res ← alloc.vec.VecTallocallocGlobal.with_capacity U8 i
  if 0#usize < N
  then
    do
    let i1 ← Array.index_usize U64 N self 0#usize
    let _ ← core.num.U64.to_le_bytes i1
    Result.fail .panic
  else Result.ret res
...
/- [test::biginteger::{(core::convert::AsMut<@Slice<u64>> for test::biginteger::BigInt<N>)#6}::as_mut]:
   Source: 'src/biginteger/mod.rs', lines 790:4-790:38 -/
...
/- Trait implementation: [test::biginteger::{(core::convert::AsMut<@Slice<u64>> for test::biginteger::BigInt<N>)#6}]
   Source: 'src/biginteger/mod.rs', lines 788:0-788:47 -/
...
/- [test::biginteger::{(core::convert::AsRef<@Slice<u64>> for test::biginteger::BigInt<N>)#7}::as_ref]:
   Source: 'src/biginteger/mod.rs', lines 797:4-797:30 -/
...
/- Trait implementation: [test::biginteger::{(core::convert::AsRef<@Slice<u64>> for test::biginteger::BigInt<N>)#7}]
   Source: 'src/biginteger/mod.rs', lines 795:0-795:47 -/
...
/- [test::biginteger::signed_mod_reduction]:
   Source: 'src/biginteger/mod.rs', lines 1058:0-1058:56 -/
